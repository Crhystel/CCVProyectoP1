...
namespace CCVProyectoP1.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,Materia")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Materia")] Profesor profesor)
        {
            if (id != profesor.IdUsuario)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProfesorExists(profesor.IdUsuario))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Profesor.Any(e => e.IdUsuario == id);
        }
    }
}
